...
namespace CodedUITestProject1
{
    public class Robot
    {
        ...
        public static UITestControl SetForm(string formName,string title)
        {
        ...
        public static void CloseWindow(string name,string title)
        {
            WinWindow window = new WinWindow();
        ...
        public static void ClickDataGridViewRowByIndex(string name, string index)
        {
            WinTable table = (WinTable)Robot.FindWinControl(typeof(WinTable), name, _root);
            WinRow row = new WinRow(table);
            row.SearchProperties.Add(WinRow.PropertyNames.RowIndex, index);
